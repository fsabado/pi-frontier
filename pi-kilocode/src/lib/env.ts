...
export const PI_KILOCODE_CACHE_DIR = path.join(PI_CODING_AGENT_DIR, "cache", "pi-kilocode");
export const PI_KILOCODE_MODELS_CACHE_FILE = path.join(PI_KILOCODE_CACHE_DIR, "models.json");
